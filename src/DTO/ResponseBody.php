...
{
    public static function createResponseFromSource(ResponseBodySourceInterface $source, ?string $responseBodyClass = null, array &$processedSources = array()): ?ResponseBody
    {
        ...
        foreach ((new ReflectionClass($response))->getProperties() as $response_property) {
            ...
            if (
                !$propertyAccessor->isWritable($response, $property_name) ||
