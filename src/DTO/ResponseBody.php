...
{
    public static function createResponseFromSource(
            ResponseBodySourceInterface $source,
            ?string $responseBodyClass = null,
            array &$processedSources = array()
    ): ?ResponseBody {
    ...
    protected function handleSourcePropertyValue(
            mixed $source_property_value, ?Type $response_property_type,
